...
plt.title('Evolução dos Percentuais de Apoio Social Modalidade Presencial', fontweight='bold')
...
arq_output = '../static/graficos/evolucao_apoio_social_presencial.png'
plt.tight_layout()
