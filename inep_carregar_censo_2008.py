...
arqs = ['d:/Trab/INEP/Microdados/censo/Censo_2008_GRADUACAO_PRESENCIAL.CSV', 'd:/Trab/INEP/Microdados/censo/Censo_2008_GRADUACAO_DISTANCIA.CSV']
for arq in arqs:
    file_patch = arq
...
for _, row in df.iterrows():
   ...
   dados_curso = {
       ...
       'qt_vg_total': soma_intervalo(row, 'C62011', 'C6620', col_todas) + soma_intervalo(row, 'C94011', 'C97101',
                                                                                         col_todas),
