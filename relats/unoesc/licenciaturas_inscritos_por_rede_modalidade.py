...
select distinct
    ...
    sum(c.qt_inscrito_total) QtdeInscritos  
from curso_censo c
...
pivot_df = df.pivot_table(index='ano', columns=['rede', 'modalidade'], values='QtdeInscritos', fill_value=0).astype(int)
...
arq_nome = 'licenciaturas_inscritos_por_rede_modalidade'
...
ax.set_title('Inscritos em Licenciaturas por Tipo de Rede e Modalidade', color='#000000', fontsize=14)
