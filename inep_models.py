...
class RegiaoImediata(db.Model):
    ...
    codigo = db.Column(db.Integer, primary_key=True)
    nome = db.Column(db.String(12), nullable=False)
    regiao_intermediaria = (db.Integer)
...
class Municipio(db.Model):
    ...
    hierarquia = db.Column(db.String(1))
    estado = db.Column(db.String(2), db.ForeignKey('uf.sigla'), nullable=False)
    mesorregiao = db.Column(db.Integer, db.ForeignKey('mesorregiao.codigo'), nullable=False)
    microrregiao = db.Column(db.Integer, db.ForeignKey('microrregiao.codigo'), nullable=False)
    regiao_intermediaria = db.Column(db.Integer, db.ForeignKey('regiao_intermediaria.codigo'), nullable=False)
    regiao_imediata = db.Column(db.Integer, db.ForeignKey('regiao_imediata.codigo'), nullable=False)
...
class MunicipioCenso(db.Model):
    ...
    domicilios = db.Column(db.Integer)
    populacao = db.Column(db.Integer)
    area = db.Column(db.Integer)
    idade_media = db.Column(db.Integer)
    tx_alfabetizacao = db.Column(db.Float)
    pop_branca = db.Column(db.Integer)
    pop_preta = db.Column(db.Integer)
    pop_parda = db.Column(db.Integer)
    pop_indigena = db.Column(db.Integer)
    pop_amarela = db.Column(db.Integer)
    pop_quilombola = db.Column(db.Integer)
    pop_estrangeiros = db.Column(db.Integer)
    pop_indigena_territorio = db.Column(db.Integer)
    pop_quilombola_territorio = db.Column(db.Integer)
    idx_razao_sexo = db.Column(db.Float)
    idx_envelhecimento = db.Column(db.Float)
    pop_19a24anos = db.Column(db.Integer)
...
class Ies(db.Model):
    ...
    tp_rede = db.Column(db.Integer, db.ForeignKey('tp_rede.codigo'), nullable=False)
