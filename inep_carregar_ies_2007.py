...
df_ies_dados = df_merged[['MASCARA', 'CO_ORG', 'NOMEORG', 'CO_REDE', 'CO_DEP', 'CATEGADM', 'CATADMPARTSE', 'CATADMCOMUN', 'CATADMCONFESS', 'CATADMFILANT', 'CODMUNIC', 'SIGLA_UF', 'NOMEDEP']]
...
df_ies_dados.drop(columns={'CATEGADM','NOMEDEP', 'CATADMPARTSE', 'CATADMCOMUN', 'CATADMCONFESS', 'CATADMFILANT', 'municipio_codigo', 'MASCARA'}, inplace=True)
